export default function StepsComplete() {
  return (
    <div>
      ...
      <p>Remember, all our steps depend on each other, we cannot start in the middle of the flow.</p>
      <p>It doesn't matter if we press the browser back button or the one below. The middleware will take care of it :)</p>
      <span
